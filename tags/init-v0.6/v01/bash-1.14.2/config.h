...
pid_t nt_execute_disk_command (WORD_LIST *words, REDIRECT *redirects,char *command, int pipe_in, int pipe_out, int async, struct fd_bitmap *fds_to_close, int nofork, const char * shell);
