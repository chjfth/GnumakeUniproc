...
SvnCoCmd=svn.exe co %SvnRootUrl%/%SvnReposie%/%SvnBranchie%@"{{%SvnCoTimeStamp%}}" -r "{{%SvnCoTimeStamp%}}" "%fnbksl%(%DirLocal%)"
SvnExportCmd=svn.exe export --force %SvnRootUrl%/%SvnReposie%/%SvnBranchie%@"{{%SvnCoTimeStamp%}}" -r "{{%SvnCoTimeStamp%}}" "%fnbksl%(%DirLocal%)"
