...
export gmp_ud_list_CUSTOM_MKI="$gmp_ud_list_CUSTOM_MKI $gmu_DIR_ROOT/GMU-ext $gmu_DIR_ROOT/extras/nlscan/gmu-ext"
export gmp_ud_list_CUSTOM_COMPILER_CFG="$gmp_ud_list_CUSTOM_COMPILER_CFG $gmu_DIR_ROOT/extras/nlscan/compiler-cfgs"
